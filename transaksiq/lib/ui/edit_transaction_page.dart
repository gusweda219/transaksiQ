                ...
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        setState(() {
                          type = EditTransactionPage.income;
                        });
                      },
                      child: Container(
                        height: 50,
                        decoration: BoxDecoration(
                          color: type == EditTransactionPage.income
                              ? incomeColor
                              : Colors.grey[300],
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () {
                        setState(() {
                          type = EditTransactionPage.expense;
                        });
                      },
                      child: Container(
                        height: 50,
                        decoration: BoxDecoration(
                          color: type == EditTransactionPage.expense
                              ? expenseColor
                              : Colors.grey[300],
                          borderRadius: const BorderRadius.only(
                      ...
                      await FirestoreDatabase.updateTransaction(
                          ...
                          transaction_model.Transaction(
                              id: (widget.data['transaction']
                                      as transaction_model.Transaction)
                                  .id,
                              type: type == EditTransactionPage.income
                                  ? 'Pemasukan'
                                  : 'Pengeluaran',
