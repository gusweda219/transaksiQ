...
class AddAutomaticTransactionPage extends StatefulWidget {
  static const routeName = '/add_automatic_transaction_page';
  const AddAutomaticTransactionPage({Key? key}) : super(key: key);

  @override
  _AddAutomaticTransactionPageState createState() =>
      _AddAutomaticTransactionPageState();
}

class _AddAutomaticTransactionPageState
    extends State<AddAutomaticTransactionPage> {
  final days = {
    'sunday': 'M',
    'monday': 'S',
    'tuesday': 'S',
  ...
  bool _isCalcKeyboardVisible = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Tambah Pencatatan Otomatis'),
        centerTitle: true,
      ),
      body: Stack(
        children: [
